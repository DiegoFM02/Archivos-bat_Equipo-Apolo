::ESTE CODIGO ES EL QUE MODIFICO EL EQUIPO APOLO DE ACUERDO A LA SOLICITUD DE TILINESFC
::
::
...
::PROPUESTA DE EQUIPO APOLO: el ciclo for se puede eliminar, ya que, si lo dejamos, se crea recursividad y se vuelve un ciclo infnito, abriendo muchas ventanas de la consola
::Lo vamos a comentar para que se vea como funciona sin tener el ciclo
...
:: Se calcula la distancia y el tiempo entre estaciones
::
...
::
::Hasta aqui terminamos de calcular las distancias y tiempos entre estaciones de la linea 1
::
...
echo El tiempo estimado de viaje de la estacion %origen% a la estacion %destino% es %tiempoTotal% minutos.
::
::Hasta aqui terminamos de calcular las distancias y tiempos entre estaciones de la linea 2
::
...
echo El tiempo estimado de viaje de la estacion %origen% a la estacion %destino% es %tiempoTotal% minutos.
::
::Hasta aqui terminamos de calcular las distancias y tiempos entre estaciones de la linea 4
::
...
echo El tiempo estimado de viaje de la estacion %origen% a la estacion %destino% es %tiempoTotal% minutos.
::
::Hasta aqui terminamos de calcular las distancias y tiempos entre estaciones de la linea 5
::
...
echo El tiempo estimado de viaje de la estacion %origen% a la estacion %destino% es %tiempoTotal% minutos.
::
::Hasta aqui terminamos de calcular las distancias y tiempos entre estaciones de la linea 6
::
...
echo El tiempo estimado de viaje de la estacion %origen% a la estacion %destino% es %tiempoTotal% minutos.
::
::Hasta aqui terminamos de calcular las distancias y tiempos entre estaciones de la linea 7
::
...
echo El tiempo estimado de viaje de la estacion %origen% a la estacion %destino% es %tiempoTotal% minutos.
::
::Hasta aqui terminamos de calcular las distancias y tiempos entre estaciones de la linea 8
::
...
echo El tiempo estimado de viaje de la estacion %origen% a la estacion %destino% es %tiempoTotal% minutos.
::
::Hasta aqui terminamos de calcular las distancias y tiempos entre estaciones de la linea 9
::
...
echo El tiempo estimado de viaje de la estacion %origen% a la estacion %destino% es %tiempoTotal% minutos.
::
::Hasta aqui terminamos de calcular las distancias y tiempos entre estaciones de la linea A
::
...
echo El tiempo estimado de viaje de la estacion %origen% a la estacion %destino% es %tiempoTotal% minutos.
::
::Hasta aqui terminamos de calcular las distancias y tiempos entre estaciones de la linea B
::
...
echo El tiempo estimado de viaje de la estacion %origen% a la estacion %destino% es %tiempoTotal% minutos.
::
::Hasta aqui terminamos de calcular las distancias y tiempos entre estaciones de la linea 12
::
