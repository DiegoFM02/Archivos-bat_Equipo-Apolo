::Segunda parte del ejercicio donde se le agrega la opcion de ordenar de mayor a menor
...
cls
echo ***********************************************
echo *** Ejercicio editado por el equipo Tilinesfc***
echo ******************* 4CV3 **********************
echo ***********************************************
echo ===============================================
...
:: Mostrar los numeros ordenados de mayor a menor
echo.
